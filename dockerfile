...
# Install torch and torchvision from nightly, but use compatible torchaudio version
# pyannote.audio requires torchaudio with AudioMetaData (available in 2.0.x - 2.3.x)
# Explicitly install torchaudio 2.3.0 which has AudioMetaData and supports CUDA 12.8
RUN uv pip install --system -e . \
    ...
    && uv pip install --system torchaudio==2.3.0 --index-url https://download.pytorch.org/whl/cu128 \
